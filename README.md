...
[![img](https://github.com/Team-1111/bankbankatm/raw/master/giphy.gif)](https://github.com/Team-1111/bankbankatm/blob/master/giphy.gif) Example of how customers use this system [![img](https://github.com/Team-1111/bankbankatm/raw/master/giphys.gif)](https://github.com/Team-1111/bankbankatm/blob/master/giphys.gif)
...
- Maintainer(IT Technician from Bank) It should be easy to maintain the whole system. The maintainer should be the only person that is allowed to connect a new ATM to the network.
...
[![context diagram](https://github.com/Team-1111/bankbankatm/raw/master/UML/atmsystemcontext.jpg)](https://github.com/Team-1111/bankbankatm/blob/master/UML/atmsystemcontext.jpg)
...
- Description Initialize parameters t,k,m,n. (t = Total fund in the ATM at start of day, k = Maximum withdrawal per day and account, m = mMximum withdrawal per transaction, n = Minimum cash in the ATM to permit a transaction)
...
- Processing : Check if the amount of money doesn't exceed k (k = Maximum withdrawal per day and account)
...
[![ATMInterface](https://github.com/Team-1111/bankbankatm/raw/master/ATM.PNG)](https://github.com/Team-1111/bankbankatm/blob/master/ATM.PNG)
